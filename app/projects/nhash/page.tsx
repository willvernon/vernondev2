...
export default function Project4() {
	...
	return (
		<>
			<motion.div
				className="fixed z-100 top-0 left-0 right-0 h-2 bg-red-500 transform-origin-right"
				style={{ scaleX }}
			/>
			<BackArrow />
			<div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-6 w-full">
				...
				<div className="mb-8 prose dark:prose-dark leading-relaxed">
					...
					<p>
						...
						BitCoin Miners. He also requested a way that he could have a
						web app open on his monitor so we can see live feedback of
					...
					<p>
						I interviewed the CEO on what he wanted the final product to
						look like and since this was a service only one person was
						going to use i only need input from one person.
					</p>
					...
					<p>
						...
						was key in what the CEO wanted so that it can sit on a
						TV/Monitor and require no intervention to have relevant and
						updated information.
					</p>
					<br />
				...
				<div className="w-[100%] h-[100%] relative">
					...
					<p>
						...
						out features and with some of the team. (Had to remove the
					...
					<li className="p-1">
						You have to pick and choose what information you want to
						include so that theres no information overload
					</li>
					<li className="p-1">
					...
					<br />
					<li className="p-1">
						Making a very simplistic way to view complex data to make it
						easy to read for non-technical eyes.
					</li>
					<li className="p-1">
						Also makes it easy to view information from the rig without
						being directly next to it.
					</li>
				</div>
			</div>
		</>
