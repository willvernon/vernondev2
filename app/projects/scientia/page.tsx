			...
			<div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-6 w-full">
				...
				<div className="mb-8 prose dark:prose-dark leading-relaxed">
					...
					<p>
						...
						given the very lackluster of school based organizational tools
						in 2018-19, i took matters into my own hands to come up with a
						app that specifically tailored to mine and many other college
					...
					<p>
						...
						order to gather the information I needed. These students spoke
						to me on how they managed their productive strategies whether
						it was digital or pen and paper. Here are the findings:
					</p>
					<div className="grid grid-cols-2 gap-12">
						<div>
							...
							<li className="p-1">
								...
								comes to work management 
							</li>
							<li className="p-1">
								Interviewees use lots of journaling and the reminders
								app in their phone.
							</li>
							<li className="p-1">
						...
						<div>
							...
							<li className="p-1">
								Learning a new organization method can be time
								restrictive
							</li>
							<li className="p-1">
					...
					<p>
						👉🏼 I observed that organization and assignment management is
						very important when keeping a strong academic and personal
						life mixture, having each assignment accounted for allows for
					...
					<p>
						...
						have received i went along and made some rough sketches about
						how i think it should look and run:
					</p>
					<br />
					<h2>Sketches & Paper Prototypes</h2>
					<p>
						After going through a few paper sketches i came to that final
						design and went to make wireframes and user flows. My key was
						to keep the pages and navigation to a minimum to keep
						quickness a priority.
					</p>
					<br />
				...
				<div className="w-[100%] h-[100%] relative">
					...
					<br />
					<p>
						There are limitations when it comes to building a task app.
					...
					<li className="p-1">
						...
						their organization and task management will only save to
						device till connection is reestablished.
					</li>
					<li className="p-1">
						Takes time to establish confidence and reliance on the app.
					</li>
					<li className="p-1">
						Everyone is very different in the way they like to stay
						organized so building to include everyone can be difficult.
					</li>
					<br />
					...
					<li className="p-1">
						...
						reliant on good software to support the emerging digitization
						of school.
					</li>
				</div>
			</div>
