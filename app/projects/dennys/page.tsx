		...
		<>
			...
			<div className="mx-auto mb-6 flex w-full max-w-2xl flex-col items-start justify-center">
				...
				<div className="relative h-[25rem] w-[100%]">
					...
					<Image
						className="z-[-10] absolute rounded-[2rem]"
						layout="fill"
						objectFit="cover"
						src={hero}
						alt="/"
				...
				<div className="prose mb-8 leading-relaxed dark:prose-dark">
					...
					<p>
						...
						clean, intuitive design with a focus on high-quality visuals
						such as images and videos of boats and the marina. The website
						has easy navigation with clear calls-to-action buttons for
						users to browse inventory, schedule appointments, and request
						information. It also includes a responsive design that adapts
						to different screen sizes, as well as fast loading times to
						ensure a seamless user experience. Additionally, the website
						has a robust CMS (content management system) to easily update
						inventory and pricing, and text throughout the website. Added
						with social media and email marketing links for effective
